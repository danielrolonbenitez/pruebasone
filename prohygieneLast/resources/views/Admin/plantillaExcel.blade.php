...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
       <td align='center' colspan="11" style="background-color:#286BCC;color:white;height:50px"><div style="padding-bottom:100px;"><strong><font face="Verdana, Arial, Helvetica, sans-serif"><font size="4">Inscripción de Cursos {{utf8_decode($data[0]->periodoNombre)}}</font></font></strong></div></td>
