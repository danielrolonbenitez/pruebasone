...
<body data-layout="fixed">
  ...
  padding-top: 15px;">
		<div class="container-fluid">
			<a href="#" id=""><img src="http://came.sandiamanagement.com/images/came_logo.svg" alt=""></a>
						...
						<div class="box">
							...
							<div class="box-content">
								<form action="<?php echo $actionUrl; ?>" method="POST" class='form-horizontal' enctype="multipart/form-data">
									<input type="hidden" name="identidad" class="form-control" value="<?php $data['identidad']; ?>">
									<input type="hidden" name="identidad" class="form-control" value="<?php $data['id_actividad']; ?>">
									<div class="form-group">
										<label for="textfield" class="control-label col-sm-2">Categoría:</label>
										<div class="col-sm-10">
											<select name="categoria" id="s2" class="select2-me select2-offscreen" style="width:250px;" tabindex="-1" title="" required>
												<option value="01">Sensibilización</option>
												<option value="02">Capacitación</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="nombre_actividad" id="textfield" class="form-control" value="<?php echo $data['nombre_actividad']; ?>" required>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="fecha" id="textfield" class="form-control mask_date" value="<?php echo $data['fecha']; ?>" required>
											<span class="help-block">Formato: 00/00/0000</span>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<div class="bootstrap-timepicker">
												<input type="text" name="hora" id="timepicker" class="form-control timepick" value="<?php echo $data['hora']; ?>" required>
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="lugar" id="textfield" class="form-control" value="<?php echo $data['lugar']; ?>" required>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea name="texto_corto" id="textarea" class="form-control" required><?php echo $data['texto_corto']; ?></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea name="texto_largo" id="textarea" class="form-control" style="height: 200px;" required><?php echo $data['texto_largo']; ?></textarea>
										</div>
									</div>
									<div class="form-group">
										<label for="textfield" class="control-label col-sm-2">Sitio web (opcional)</label>
										<div class="col-sm-10">
											<input type="text" name="sitio_web" id="textfield" class="form-control" value="<?php echo $data['sitio_web']; ?>" required>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea name="notas" id="textarea" class="form-control" required><?php echo $data['notas']; ?></textarea>
										</div>
									</div>
									<div class="box-title">
								<h3>
							...
							<br><br>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="cantidad_asistentes" id="textfield" class="form-control" value="<?php echo $data['cantidad_asistentes']; ?>" required>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea name="informacion_reservada" id="textarea" class="form-control" required><?php echo $data['informacion_reservada']; ?></textarea>
										</div>
									</div>
