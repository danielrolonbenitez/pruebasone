...
jQuery("#list2").jqGrid({
   	url:'presupuesto.list.php?tipo=f',
	datatype: "json",
   	colNames:['Id','Federacion','Provincia','Ciudad','Recaudación','Presupuesto Aprobado','Fecha de Aprobación','Consumido','Saldo','Pagos Extaordinarios'],
   	colModel:[
   		
		{name:'id',index:'id', width:50,editable:false, key:true},
		{name:'federacion',index:'federacion',width:400, editable: false},
		{name:'provincia',index:'provincia', editable: false},
		{name:'ciudad',index:'ciudad', editable: false},
		{name:'recaudacion',index:'recaudacion',width:80, editable: true,editrules:{number:true}},
		{name:'presupuesto',index:'presupuesto',width:80, editable: true,editrules:{number:true}},
		{name:'fecha',index:'fecha',  width:100,editable:true,editoptions:{dataInit:function(e){$(e).datepicker({dateFormat:'dd/mm/yy'});},size:10}},
		{name:'consumido',index:'consumido',width:80, editable: true,editrules:{number:true}},
		{name:'saldo',index:'saldo',width:80, editable: true,editrules:{number:true}},
	...
	//multiselect: true, 
	cellEdit: true,
	cellurl:"presupuesto.edit.php?tipo=f",
   	rowNum:50,
	rownumbers: true,
   	rowList:[30,50,100,200,500],
   	imgpath: gridimgpath,
   	pager: jQuery('#pager2'),
   	sortname: 'f.fed_nombre',
    viewrecords: true,
	forceFit : true,
    sortorder: "asc",
	autowidth: true,
	...
	/*	height: "150px",	 */
	caption:"Presupuesto - Federaciones",
	loadComplete: eachrow,
	
	
	/* estilo en filas */
	afterInsertRow: function(rowid, aData){  	
   	$("#list2").setCell(rowid,'federacion','',{'font-weight':'bold'});
