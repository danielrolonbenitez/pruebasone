...
jQuery("#list2").jqGrid({
   	url:'presupuesto.list.php?tipo=c',
	datatype: "json",
   	colNames:['Id','Cámara','Provincia','Ciudad','Recaudación','Presupuesto Aprobado','Fecha de Aprobación','Consumido','Saldo','Pagos Extaordinarios'],
   	colModel:[
   		
		{name:'id',index:'id', width:50,editable:false, key:true},
		{name:'camara',index:'camara',width:400, editable: false},
	...
	//multiselect: true, 
	cellEdit: true,
	cellurl:"presupuesto.edit.php?tipo=c",
   	rowNum:50,
	rownumbers: true,
   	rowList:[30,50,100,200,500],
   	imgpath: gridimgpath,
   	pager: jQuery('#pager2'),
   	sortname: 'c.cam_nombre',
    viewrecords: true,
	forceFit : true,
    sortorder: "asc",
	autowidth: true,
	...
	/*	height: "150px",	 */
	caption:"Presupuesto - Cámaras",
	loadComplete: eachrow,
	
	
	/* estilo en filas */
	afterInsertRow: function(rowid, aData){  	
   	$("#list2").setCell(rowid,'camara','',{'font-weight':'bold'});
