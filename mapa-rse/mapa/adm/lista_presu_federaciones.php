...
<script src="js/lista_presu_federaciones.js"></script>
...
$query=mysql_query("select f.id_federacion id from federaciones f WHERE NOT EXISTS (select r.id_federacion from rel_presupuesto r where r.id_federacion=f.id_federacion)");  echo mysql_error();
while ($dat=mysql_fetch_array($query))
{
	mysql_query("insert into presupuesto set recaudacion='0'"); $idd=mysql_insert_id();
	mysql_query("insert into rel_presupuesto set id_presupuesto='$idd', id_federacion='$dat[id]'");	
}
