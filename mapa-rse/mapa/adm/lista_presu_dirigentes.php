...
<script src="js/lista_presu_dirigentes.js"></script>
...
$query=mysql_query("select d.id_dirigente id from dirigentes d WHERE NOT EXISTS (select r.id_dirigente from rel_presupuesto r where r.id_dirigente=d.id_dirigente)");  echo mysql_error();
while ($dat=mysql_fetch_array($query))
{
	mysql_query("insert into presupuesto set recaudacion='0'"); $idd=mysql_insert_id();
	mysql_query("insert into rel_presupuesto set id_presupuesto='$idd', id_dirigente='$dat[id]'");	
}
