 ...
 */
	public function input($fieldName, $options = array()) {
		...
		$out['input'] = $this->_getInput(compact('placeholder', 'type', 'fieldName', 'options', 'radioOptions', 'selected', 'dateFormat', 'timeFormat'));
		// VNS
		$out['input'] = '<span class="holo">' . $out['input'] . '</span>';
