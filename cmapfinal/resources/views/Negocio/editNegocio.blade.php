...
@section('content')
  ...
  <div class="row">
      	<div class="col-lg-8 col-lg-offset-2" style="background:rgba(0,0,0,0.5);padding:50px;color:white;">
				...
				<form   class="" role="form"   id="negocioForm" action="{{route('negocioEditStore')}}" method="POST" enctype="multipart/form-data">
				...
				<div class="row"> 
									...
									<div class="col-lg-5">
                                             ...
                                             <input type="hidden" value="<?php echo $negocios[0]->idNegocio; ?>" name="idNegocio" >
											    ...
											    <input type="text" class="form-control" name="razonSocial" id="razonSocial" value="{{$negocios[0]->razonSocial}}"><br></br>
											  
											    <label for="direccion">Direccion:</label><br>
											    <input type="text" class="form-control" name="direccion" id="direccion" value="{{$negocios[0]->direccion}}"><br>
												...
												<?php foreach($provincias as $provincia){  ?>
														...
														<option value="{{$provincia->idProvincia}}"<?php if($provincia->idProvincia==$negocios[0]->idProvinciaF)echo "selected='selected'"; ?> ><?php echo $provincia->nombre; ?></option>
												...
												<?php foreach($ciudades as $ciudad){  ?>
														...
														<option value="{{$ciudad->idCiudad}}"<?php if($ciudad->idCiudad==$negocios[0]->idCiudadF)echo "selected='selected'"; ?> ><?php echo $ciudad->nombre; ?></option>
								...
								<div class="form-group col-lg-5 col-lg-offset-1">
											    ...
											    <input type="text" class="form-control" name="sitioWeb" id="sitioWeb" value="{{$negocios[0]->sitioWeb}}"><br>
											


											
											    <label for="telefono">Telefono:</label><br>
											    <input type="text" class="form-control" name="telefono" id="telefono" value="{{$negocios[0]->telefono}}"><br>
								...
								<div class="row">
									...
									<br></br>
								      ...
								      <div class="col-lg-12" style="margin-top:50px;background:silver;padding-bottom:20px" >
								      	...
								      	<div><span style="font-size:30px;margin-right:30%">Foto Slider</span><a href="{{route('addMorePic',$negocios[0]->idNegocio)}}" class="btn btn-success">Agregar Mas Fotos Slider</a></div>
										<div class="alert alert-success">
...
<script src="{{URL::asset('js/editNegocio.js')}}"></script>
<script>
